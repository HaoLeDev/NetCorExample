...
namespace DemoLogin.Controllers
{
    public class EmployeesTestController : Controller
    {
        ...
        public EmployeesTestController(DemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,De_Id,Em_Code,FirstName,LastName,BirthDate,Phone,IdentityCardNumber,Sex,Address,Image,Status")] Employee employee)
        {
